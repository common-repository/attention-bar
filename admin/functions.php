...
function nb_get_username($userid) {
...
function nb_notice($messages,$options){
	$dismissbeta = '<span style="float:right;"><a href="' . admin_url('admin.php?page=pd_sub_settings&betacheck=true&noheader=true') . '">' . __('Stop bugging me','attention-bar') . '</a></span>';
	$dismissversion = '<span style="float:right;"><a href="' . admin_url('admin.php?page=pd_sub_settings&versioncheck=true&noheader=true') . '">' . __('Stop bugging me','attention-bar') . '</a></span>';
...
function nb_admin_notices() {
	...
	if (version_compare($wp_version,"3.3",">") && version_compare(get_option('pd_nb_betanotification'),NB_VERSION,"<")){
		...
		<div class="metabox-holder">	
			<div class="meta-box-sortables ui-sortable">
				<div id="info" class="postbox">
					...
					<h3 class="hndle">
						<span>' . __('Information','attention-bar') . '</span>
					</h3>
					<div class="inside">
					<h4>Support</h4>
					<br class="clear">
					<ul>
						<li><a href="http://wordpress.org/extend/plugins/attention-bar/" target="_blank">WordPress Plugin page</a></li>
						<li><a href="http://wordpress.org/tags/attention-bar?forum_id=10" target="_blank">WordPress Forum</a></li>
