...
function nb_install_example_data() {
	...
	$table_name_data = $wpdb->prefix . "nb_data";
	$table_name_notifications = $wpdb->prefix . "nb_nottypes";
	$nb_name = __('Notification example','attention-bar');
	$nb_content = __('Congratulations, you have just installed Attention Bar !','attention-bar');
...
function nb_install_example_notifications() {
	global $wpdb;
	$table_name_notifications = $wpdb->prefix . "nb_nottypes";
	$wpdb->insert( $table_name_notifications, array( 'name' => __('TIP','attention-bar'), 'icon' => NB_URL . '/images/tip.png', 'bgcolor' => 'white', 'fontcolor' => 'black' ));
	$wpdb->insert( $table_name_notifications, array( 'name' => __('IMPORTANT','attention-bar'), 'icon' => NB_URL . '/images/important.png', 'bgcolor' => 'darkred', 'fontcolor' => 'white' ));
	$wpdb->insert( $table_name_notifications, array( 'name' => __('ANNOUNCEMENT','attention-bar'), 'icon' => NB_URL . '/images/announcement.png', 'bgcolor' => 'lightyellow', 'fontcolor' => 'black' ));
}
